...
public class BinarySearchTreeTester {
    ...
    public void testRandomAddAndRemove() {
        ...
        for (int n = 0; n < 1000; n++) {
            ...
            //System.out.print("\noracle " + oracle.size() + " "+ oracle + "to add: " + toAdd);
            assertEquals(oracle.add(toAdd), tree.add(toAdd));
            //System.out.print("\noracle " + oracle.size() + " "+ oracle + "added: " + toAdd);
            //System.out.print("\ntree " + tree.size() + " "+ tree + "added: " + toAdd);
            int toRemove = rnd.nextInt(10);
            //System.out.print("\noracle " + oracle.size() + " "+ oracle + "to remove: " + toRemove);
            assertEquals(oracle.remove(toRemove), tree.remove(toRemove));
            int checkExists = rnd.nextInt(10);
            //System.out.print("\noracle " + oracle.size() + " "+ oracle + "removed: " + toRemove);
            //System.out.print("\ntree " + tree.size() + " "+ tree);
